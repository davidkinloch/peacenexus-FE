...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <link rel="mask-icon" href="/safari-pinned-tab.svg" color="#004480">
        ...
        <header class="header scrollspy" id="top">
          <nav role="navigation">
            <div class="nav-wrapper container">
              <a id="logo-container" href="/" class="brand-logo"><img src="assets/src/LogoPN.png" alt=""></a>
          ...
          <div class="notification row hide-on-med-and-down">
            <span class="center col s12"><strong>Excepteur sint</strong> occaecat cupidatat non proident, sunt in culpa qui <a href="#">officia deserunt</a></span>
          </div>
