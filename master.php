  ...
  <div class="section services">
    ...
    <div class="row">
      <div class="col s12 m6 l4">
        <div class="card">
          <div class="card-image waves-effect waves-block waves-light">
            <img src="https://dummyimage.com/680x400/ccc/333.jpg" class="responsive-img"  alt="">
          </div>
          <div class="card-content">
            <h5 class="small">Service</h5>
            <h3 class="card-title">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore</h3>
...
<div class="section banner banner-text" id="region-specific-banner">
  ...
  <div class="container">
    <div class="row">
      <div class="col s12">
        <a href="#!" class="breadcrumb">REGIONS</a>
        <a href="#!" class="breadcrumb">Central Asia</a>
      </div>
    </div>
    <div class="row">
      <div class="col s12 m12 l6">
...
<div class="section no-margin banner banner-text" id="partnername-banner" >
  <div class="container">
    <div class="row">
      <div class="col s12">
        <a href="#!" class="breadcrumb">STORIES</a>
        <a href="#!" class="breadcrumb">Partner Name</a>
      </div>
    </div>
    <div class="row">
      <div class="col s12">
...
<div class="section no-pad-bot banner" style="background-image: url(https://dummyimage.com/1440x450/ccc/333.jpg); height: 450px;">
</div>
